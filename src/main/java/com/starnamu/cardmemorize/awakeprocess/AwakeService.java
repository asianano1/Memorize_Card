package com.starnamu.cardmemorize.awakeprocess;
...
public class AwakeService extends Service {
    ...
    private static final String ACTION_START = "com.starnamu.cardmemorize.awakeprocess.ACTION_START"; // Action to start
    private static final String ACTION_KEEPALIVE = "com.starnamu.cardmemorize.awakeprocess.ACTION_KEEPALIVE"; // Action to keep alive used by alarm manager
